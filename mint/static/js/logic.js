Moralis.initialize("uMf81uQwdHFPLI55AJoM99DnLTznKU7ycHX5QwAc"); // Application id from moralis.io
Moralis.serverURL = "https://ng3sosnllbpj.usemoralis.com:2053/server"; //Server url from moralis.io
...
const options = {type: "erc721",
                 receiver: "0x6dFf352Cd31e9494780d1656D9D0D74Fa4c75E80",
...
async function login(){
  ...
  Moralis.Web3.authenticate().then(function (user) {
      ...
      console.log(user.get("ethAddress"));
      location.href="/server-side-mint"
  })
}
